...
package com.kainos.qrreader;

import com.google.android.glass.timeline.DirectRenderingCallback;
import com.kainos.qrreader.model.Landmarks;
import com.kainos.qrreader.model.Place;
 ...
 */
public class QrreaderRenderer implements DirectRenderingCallback {

    private static final String TAG = QrreaderRenderer.class.getSimpleName();
    ...
    private final QrreaderView mCompassView;
     ...
     */
    public QrreaderRenderer(Context context, OrientationManager orientationManager,
                Landmarks landmarks) {
        LayoutInflater inflater = LayoutInflater.from(context);
        mLayout = (FrameLayout) inflater.inflate(R.layout.compass, null);
        mLayout.setWillNotDraw(false);

        mCompassView = (QrreaderView) mLayout.findViewById(R.id.compass);
