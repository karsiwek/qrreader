 ...
 */
public class QrreaderService extends Service {
    ...
    private QrreaderRenderer mRenderer;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (mLiveCard == null) {
            ...
            mRenderer = new QrreaderRenderer(this, mOrientationManager, mLandmarks);

            mLiveCard.setDirectRenderingEnabled(true).getSurfaceHolder().addCallback(mRenderer);

            // Display the options menu when the live card is tapped.
            Intent menuIntent = new Intent(this, QrreaderMenuActivity.class);
