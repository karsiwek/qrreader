...
import com.kainos.qrreader.util.MathUtils;
 ...
 * card.
 */
public class QrreaderMenuActivity extends Activity {

    private final Handler mHandler = new Handler();

    private QrreaderService.CompassBinder mCompassService;
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            if (service instanceof QrreaderService.CompassBinder) {
                mCompassService = (QrreaderService.CompassBinder) service;
                openOptionsMenu();
            }
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bindService(new Intent(this, QrreaderService.class), mConnection, 0);
    }
        ...
        switch (item.getItemId()) {
            ...
            case R.id.stop:
                ...
                mHandler.post(new Runnable() {
                    ...
                    @Override
                    public void run() {
                        stopService(new Intent(QrreaderMenuActivity.this, QrreaderService.class));
                    }
                });
                return true;
            default:
